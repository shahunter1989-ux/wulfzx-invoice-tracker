-- Wulfzx.underground submit-only staff access migration
...
create table if not exists public.workspaces (
  ...
  name text not null default 'Wulfzx.underground',
...
select source_users.user_id, coalesce(nullif(preferred_settings.company_name, ''), 'Wulfzx.underground')
from source_users
